...
- 1acd366: Fix import crashes in webpack and Turbopack builds. Bundled `FONT_ASSET_ROOT` now returns a non-`file:` URL, including in Electron and pages opened from disk. Fix font loading when bundlers emit relative paths or install paths contain parentheses.
...
- 5284df5: Fix packaged font URLs in Turbopack, Vite, and webpack builds. The CommonJS build continues to use local font files in Node.js.
